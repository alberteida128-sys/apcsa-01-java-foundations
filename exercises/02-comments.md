...
p is the principal, y is the loan term, r is intrest rate

**2. What does the method return?**

 the amount of intrest paid over a time period
...
// formula for remaining balance of loan
  public static double CompoundIntrest(double principal, int loanTerm, double r) {
...
I think better vairiable names help a future reader. My reason is as it gets more complicated its easire to read. 
